      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        ...
        <div className="grid gap-6 md:gap-8 lg:grid-cols-2">
          {facilities.map((facility) => {
            ...
            const shouldTruncate = (facility.description || '').length > 400 || descriptionLines.length > 6;
            ...
            return (
              ...
              >
                ...
                <div className="mb-4 sm:mb-6 rounded-none overflow-hidden bg-gray-100">
                    ...
                    <div className="space-y-3">
                      ...
                      {shouldTruncate && (
                        <button
                          ...
                          className={`inline-flex items-center gap-2 text-sm font-semibold transition-colors duration-200 bg-gradient-to-r ${facility.color} bg-clip-text text-transparent hover:opacity-80`}
                          aria-controls={`${facility.id}-desc`}
                          aria-expanded={isExpanded}
                        >
                          {isExpanded ? (
                            <>
                              <span className="text-[initial]">Show Less</span>
                              <ChevronUp size={18} className="text-gray-600" />
                            </>
                          ) : (
                            <>
                              <span className="text-[initial]">Read More</span>
