        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-gradient-to-br from-white to-blue-50 border-t-2 border-blue-200 shadow-2xl rounded-b-3xl">
            <div className="py-4 px-2">
              ...
              <button
                onClick={() => handleMenuClick('contact')}
                className="w-full mt-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-6 py-4 rounded-xl font-bold hover:from-amber-600 hover:to-orange-600 transition-all duration-300 shadow-lg text-base"
              >
                Apply Now
              </button>
            </div>
